...
namespace {
struct qt_meta_tag_ZN10LlmServiceE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10LlmServiceE = QtMocHelpers::stringData(
    "LlmService"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10LlmServiceE[] = {
...
Q_CONSTINIT const QMetaObject LlmService::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10LlmServiceE.offsetsAndSizes,
    qt_meta_data_ZN10LlmServiceE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10LlmServiceE_t,
        // Q_OBJECT / Q_GADGET
...
void *LlmService::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10LlmServiceE.stringdata0))
